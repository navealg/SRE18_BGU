...
def score_me(system_output_file, trial_key_file,
    ...
    for ds, p_target in configuration.items():
        ...
        eer, min_c = st.compute_equalized_min_cost(ds_scores,
                                                   ...
                                                   ds_trial_labs, p_target)
        # print("********")
        st.plot_det(ds_scores, partition_masks, ds_trial_labs, p_target)
...
def main():
    ...
    for ds, res in results.items():
        ...
        #       minc, actc))
        print('{:05.2f}\t{:.3f}\t{:.3f}\t'.format(eer*100,
              minc, actc), end='')
    # print('{}\t{}\t{}\t{:.3f}'.format('Both', '--', '--', cprimary/cnt))
    print('{:.3f}'.format(cprimary/cnt))
    # plt.show()
...
# -o /Users/navealgarici/Documents/GitHub/SRE18/eval_model_0/sre16_eval_scores.tsv -l /Users/navealgarici/Documents/GitHub/SRE18/tools/scoring_software/system_output/sre18_eval_trials.tsv -r /Users/navealgarici/Documents/GitHub/SRE18/tools/scoring_software/system_output/sre18_eval_trial_key.tsv
# -o /Users/navealgarici/Documents/GitHub/SRE18/eval_model_1/sre18_eval_scores.tsv -l /Users/navealgarici/Documents/GitHub/SRE18/tools/scoring_software/system_output/sre18_eval_trials.tsv -r /Users/navealgarici/Documents/GitHub/SRE18/tools/scoring_software/system_output/sre18_eval_trial_key.tsv
